<?php
    $logo = "https://1000marche.net/wp-content/uploads/2020/03/Google-logo.png";

    $user_image = "https://www.nicepng.com/png/detail/128-1280406_view-user-icon-png-user-circle-icon-png.png";

    $nav_item = ["Introduzione","Norme sulla privacy","Termini di servizio","Tecnologie","Domande frequenti"];
    ...
    $faqs = [
        ...
        [
            ...
            "reply" => "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
                        <ol type='1'>
                            <li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. <span class='space'></span>Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
                            
                                <ol type='a' class='ol'>
                                    <li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, <span class='space2'></span>Liechtenstein e Norvegia) o in Svizzera.</li>
